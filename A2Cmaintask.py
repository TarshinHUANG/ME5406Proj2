# =============================================================================
#   Filename         : A2Cmaintask.py
#   Author           : Xue Junyuan
#   Description      : Maintask training.
# =============================================================================
...
from A2Cmaintaskenv import Ball_env  # Import environment
...
REACH_COUNT_THRESHOLD = 1000  # Accomplish the training when reach count reaches the threshold
gamma = 0.99  # Discount factor for future rewards
#####################################################################################################

# Parameters for saving weights #####################################################################
LOAD_WEIGHT = True  # load trained weight or not
LOAD_WEIGHT_DIR = 'maintask_trained'
SAVE_WEIGHT = True  # save trained weight or not
SAVE_WEIGHT_DIR = 'maintask_trained2'
#####################################################################################################
