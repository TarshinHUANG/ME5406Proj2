# =============================================================================
#   Filename         : A2Cmaintask_test.py
#   Author           : Xue Junyuan
#   Description      : Test the main task with the trained model.
# =============================================================================
...
for train_num in range(1000):
    ...
    optimizer = tf.keras.optimizers.Adam(learning_rate=0.00)  # Setup optimizer, not learning for test
    accomplished = False
