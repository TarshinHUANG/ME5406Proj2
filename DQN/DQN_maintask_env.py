...
MAX_STEPS = 2000  # the max_steps for each episode

# Adjust
ROB_SIZE = 50  # the radius of robot (supposing circle)
BALL_SIZE = 50  # the radius of football (supposing circle)
CE_FRI_ROB = 0.01  # coefficient of friction
CE_FRI_BALL = 0.005  # coefficient of friction
...
class Ball_env(gym.Env):
    ...
    def update_velocity(self, action):
        ...
        self.rob_vel[0] = self.rob_vel[0] - CE_FRI_ROB * self.rob_vel[0]
        self.rob_vel[1] = self.rob_vel[1] - CE_FRI_ROB * self.rob_vel[1]
        self.rob_vel[2] = self.rob_vel[2] - CE_FRI_ROB * self.rob_vel[2]
        # changing football velocity
        self.ball_vel[0] = self.ball_vel[0] - CE_FRI_BALL * self.ball_vel[0]
        self.ball_vel[1] = self.ball_vel[1] - CE_FRI_BALL * self.ball_vel[1]
